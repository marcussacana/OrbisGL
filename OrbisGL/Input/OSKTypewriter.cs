...
namespace OrbisGL.Input
{
    internal class OSKTypewriter : ITypewriter, IDisposable
    {
        ...
        public string CurrentText {
            ...
            {
                _CurrentText = value;
                if (CurrentText.Length > Constants.ORBIS_IME_MAX_TEXT_LENGTH)
                    _CurrentText = CurrentText.Substring(0, Constants.ORBIS_IME_MAX_TEXT_LENGTH);
        ...
        {
            Buffer = Marshal.AllocHGlobal((Constants.ORBIS_IME_MAX_TEXT_LENGTH + 1) * 2);
            CurrentText = "";
        }
        ...
        public unsafe void Enter(Rectangle TextArea)
        {
            ...
            DiagParam.maxTextLength = Constants.ORBIS_IME_MAX_TEXT_LENGTH;
        ...
        private unsafe void UpdateText()
        {
            ...
            if (sceImeDialogGetResult(pResult) != Constants.ORBIS_OK)
                return;
