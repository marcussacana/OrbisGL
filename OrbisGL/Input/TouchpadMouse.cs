...
namespace OrbisGL.Input
{
    public class TouchpadMouse : IMouse
    {
        ...
        long ElapsedTouchStartMilesecond => (LastRefreshTick - FingerTouchStartTick) / Constants.ORBIS_MILISECOND;
        long ElapsedTouchEndMilesecond => (LastRefreshTick - FingerTouchEndTick) / Constants.ORBIS_MILISECOND;
