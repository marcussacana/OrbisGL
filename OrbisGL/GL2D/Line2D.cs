        ...
        public override void RefreshVertex()
        {
            ...
            */
            ...
            foreach (var Line in Lines)
            {
                ...
                var Begin = new Vector3(XToPoint(BeginPos.X, ZoomMaxWidth), YToPoint(BeginPos.Y, ZoomMaxHeight), -1);
                var End = new Vector3(XToPoint(EndPos.X, ZoomMaxWidth), YToPoint(EndPos.Y, ZoomMaxHeight), -1);
